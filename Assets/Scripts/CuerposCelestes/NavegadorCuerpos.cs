        ...
        switch (tipo)
        {
            case 1:
                textoInfo.text =
                    ...
                    "\n" +
                    "Las estrellas nacen en enormes nubes de gas y polvo llamadas nebulosas. Con el tiempo, la gravedad junta estos materiales hasta formar una nueva estrella.";
                break;
            ...
            case 2:
                textoInfo.text =
                    ...
                    "\n" +
                    "Es la etapa más larga de la vida de una estrella. Durante este tiempo, produce luz y calor, como nuestro Sol.";
                break;
            ...
            case 3:
                textoInfo.text =
                    ...
                    "\n" +
                    "Cuando una estrella agota su energía, cambia según su tamaño. Algunas se convierten en enanas blancas y otras explotan formando supernovas o agujeros negros.";
                break;
            ...
            case 4:
                textoInfo.text =
                    ...
                    "\n" +
                    "Tienen forma de remolino con brazos llenos de estrellas. La Vía Láctea, donde vivimos, es una galaxia espiral.";
                break;
            ...
            case 5:
                textoInfo.text =
                    ...
                    "\n" +
                    "Tienen forma redonda u ovalada. Contienen muchas estrellas antiguas y poco gas.";
                break;
            ...
            case 6:
                textoInfo.text =
                    ...
                    "\n" +
                    "No tienen una forma definida. Parecen desordenadas porque han cambiado por choques o movimientos en el espacio.";
                break;
            ...
            case 7:
                textoInfo.text =
                    ...
                    "\n" +
                    "Son cuerpos que giran alrededor de un planeta. La Luna es el satélite natural de la Tierra.";
                break;
            ...
            case 8:
                textoInfo.text =
                    ...
                    "\n" +
                    "Son máquinas creadas por las personas y enviadas al espacio para orbitar la Tierra. Sirven para comunicarnos, tomar fotos y estudiar el universo.";
                break;
            ...
            case 9:
                textoInfo.text =
                    ...
                    "\n" +
                    "Los cometas son cuerpos de hielo, polvo y roca que viajan por el espacio. Cuando se acercan al Sol, el calor forma una brillante cola.";
                break;
            ...
            case 10:
                textoInfo.text =
                    ...
                    "\n" +
                    "Los asteroides son grandes rocas espaciales que giran alrededor del Sol. La mayoría se encuentra entre Marte y Júpiter.";
                break;
